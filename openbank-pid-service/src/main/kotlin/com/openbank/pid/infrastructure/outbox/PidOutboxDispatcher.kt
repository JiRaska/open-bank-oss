...
/**
 * Drains the pid transactional outbox (ADR-0050 / ADR-0049 D3).
 *
 ...
 * for the whole rollout duration, and both dispatch on their own tick. `PidOutboxRepositoryImpl`
 ...
 */
@ApplicationScoped
class PidOutboxDispatcher(
    private val repo: PidOutboxRepository,
    ...
    @Scheduled(
        ...
        identity = "pid-outbox-dispatcher",
    )
    @Bulkhead(1)
