...
--   SELECT count(*) FROM pid_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE pid_outbox DROP CONSTRAINT IF EXISTS pid_outbox_created_at_plausible;
ALTER TABLE pid_outbox
    ADD CONSTRAINT pid_outbox_created_at_plausible
