    ...
    override fun process(paymentId: UUID): SepaPaymentStatus {
        ...
        return when (decision) {
            ...
            ScreeningDecision.CLEAR -> {
                ...
                // on RJCT) — or holding at VALIDATED if the gateway is unreachable or the pilot flag is
                // off. The synchronous (non-Temporal) path does the same via SepaPaymentService.
