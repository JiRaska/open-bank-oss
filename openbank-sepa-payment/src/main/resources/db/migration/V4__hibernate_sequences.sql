...
-- Rollback: DROP SEQUENCE sepa_payments_seq,sepa_payment_outbox_seq;

CREATE SEQUENCE IF NOT EXISTS sepa_payments_seq INCREMENT BY 50;
CREATE SEQUENCE IF NOT EXISTS sepa_payment_outbox_seq INCREMENT BY 50;
