...
--   SELECT count(*) FROM sepa_payment_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE sepa_payment_outbox DROP CONSTRAINT IF EXISTS sepa_payment_outbox_created_at_plausible;
ALTER TABLE sepa_payment_outbox
    ADD CONSTRAINT sepa_payment_outbox_created_at_plausible
