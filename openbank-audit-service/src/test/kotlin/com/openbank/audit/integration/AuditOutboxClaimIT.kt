...
import com.openbank.audit.infrastructure.persistence.repository.AuditOutboxRepositoryImpl
...
/**
 * Regression coverage for #1201: two dispatcher instances racing [AuditOutboxRepositoryImpl]'s
...
class AuditOutboxClaimIT {

    @Inject
    lateinit var repository: AuditOutboxRepositoryImpl
