...
/**
 * Drains the audit transactional outbox (ADR-0050 / ADR-0049 D3).
 *
 ...
 * for the whole rollout duration, and both dispatch on their own tick. `AuditOutboxRepositoryImpl`
...
class AuditOutboxDispatcher(
    private val repo: AuditOutboxRepository,
    ...
    @Scheduled(
        ...
        identity = "audit-outbox-dispatcher",
    )
    @Bulkhead(1)
