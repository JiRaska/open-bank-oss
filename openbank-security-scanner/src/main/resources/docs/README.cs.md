...
| [02 — Architecture](./02-architecture.md) | Engineering, tech leads | C4 diagramy, scan pipeline, outbox flow |
| [03 — API](./03-api.md) | Service developers, integrátoři | REST kontrakt, model výsledků skenů, ICT incident API |
| [04 — Data](./04-data.md) | Data, analytics, DBA | Schema, migrace, retence |
