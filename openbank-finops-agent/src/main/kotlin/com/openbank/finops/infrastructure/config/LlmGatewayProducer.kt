...
/**
 * Produces the shared [LlmGatewayPort] (ADR-0174) for the finops-agent.
 *
...
class LlmGatewayProducer {
    ...
    @Produces
    @ApplicationScoped
    fun llmGateway(config: FinOpsConfig, metrics: LlmCallMetrics): LlmGatewayPort {
        val apiKey = ConfigProvider.getConfig()
            .getOptionalValue("finops-agent.model.api-key", String::class.java)
            .orElse("")
