...
--   SELECT count(*) FROM aml_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE aml_outbox DROP CONSTRAINT IF EXISTS aml_outbox_created_at_plausible;
ALTER TABLE aml_outbox
    ADD CONSTRAINT aml_outbox_created_at_plausible
