...
-- Rollback: DROP SEQUENCE aml_cases_seq,aml_outbox_seq;

CREATE SEQUENCE IF NOT EXISTS aml_cases_seq INCREMENT BY 50;
CREATE SEQUENCE IF NOT EXISTS aml_outbox_seq INCREMENT BY 50;
