...
test.beforeEach(async ({ context, baseURL, page }) => {
  ...
  await page.route('**/api/test-intelligence', route => route.fulfill({ status: 200, contentType: 'application/json', body: JSON.stringify({
    ...
    contracts: [], mutations: [], performance: [{ id: 'money-path-smoke', component: null, state: 'passed', observedAt: '2026-08-22T10:00:00.000Z', source: 'perf/k6/money-path-smoke.js', thresholds: 1, metrics: { p95Ms: 220.4, errorRatePercent: 0.2, checkPassRatePercent: 99.8, requests: 150 } }], performanceHistory: [],
    syntheticJourneys: [{ id: 'public-edge', title: 'Public edge reachability', status: 'active', state: 'passed', severity: 'page', schedule: '*/5 * * * *', environment: 'sandbox', covers: [], falsifies: 'Break the public edge.', blocker: null, live: { source: 'prometheus', observedAt: '2026-08-22T12:00:00.000Z', lastScheduledAt: '2026-08-22T11:55:00.000Z', lastSuccessfulAt: '2026-08-22T11:56:00.000Z', failuresWithinWindow: 0, failureWindowSeconds: 900, activeJobs: 0, freshnessSeconds: 240, recentRuns: [{ id: 'public-edge-1', state: 'passed', observedAt: '2026-08-22T11:56:00.000Z' }] } }, { id: 'admin-ui-sso-boundary', title: 'Admin UI SSO boundary', status: 'active', state: 'not-run', severity: 'ticket', schedule: '13 */2 * * *', environment: 'sandbox', covers: [], falsifies: 'Remove the SSO boundary.', blocker: null, ci: { state: 'not-run', observedAt: '2026-08-22T12:00:00.000Z', detail: '1/2 declared browser variants passed.', run: { id: '7711', attempt: 1, commit: '1234567890abcdef', branch: 'main', workflow: 'Admin UI browser synthetic', url: 'https://example.test/run/7711', observedAt: '2026-08-22T12:00:00.000Z' }, variants: [{ browser: 'chromium', state: 'passed', observedAt: '2026-08-22T12:00:00.000Z', detail: 'Browser E2E and attributable Web Vitals passed.', run: { id: '7711', attempt: 1, commit: '1234567890abcdef', branch: 'main', workflow: 'Admin UI browser synthetic', url: 'https://example.test/run/7711', observedAt: '2026-08-22T12:00:00.000Z' } }, { browser: 'firefox', state: 'not-run', observedAt: null, detail: 'No retained immutable envelope for this declared browser variant.' }] } }, { id: 'mobile-critical-path', title: 'Mobile login, overview and payment UI', status: 'planned', state: 'blocked', severity: 'page', schedule: '0 * * * *', environment: null, covers: [], falsifies: 'Break one app route.', blocker: 'Needs managed Android/iOS canary devices.' }],
