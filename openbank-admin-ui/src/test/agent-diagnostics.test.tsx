...
describe('agent operating diagnostics', () => {
  ...
  it('explains the swarm on the AIOps overview without presenting it as live topology', () => {
    ...
    expect(screen.getByRole('link', { name: /Meet Chord/ })).toHaveAttribute('href', '/iaops/agents/case-coordinator')
    expect(screen.getByRole('link', { name: /Explore chartered roles/ })).toHaveAttribute('href', '/iaops#agent-roster')
    expect(screen.getByRole('link', { name: /Open case threads/ })).toHaveAttribute('href', '/iaops/cases')
