...
const COMPLIANCE_AREAS: ComplianceArea[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { req: ['Marketingový souhlas', 'Marketing consent'], status: 'warn', note: ['Souhlas se zapisuje (party-service, #1157/#1161), ale žádný send-path ho nekontroluje — issue #2369', 'Consent is captured (party-service, #1157/#1161), but no send path checks it — issue #2369'] },
      ...
      { req: ['Přenositelnost dat (Art. 20)', 'Data portability (Art. 20)'], status: 'warn', note: ['ADR-0118 se k Art. 20 nevyjadřuje — rozsah, formát a Art. 20(2) nejsou rozhodnuté, issue #2371', 'ADR-0118 is silent on Art. 20 — scope, format and Art. 20(2) are undecided, issue #2371'] },
    ],
  },
  {
    id: 'eba-ict',
