...
const FeedbackChart = dynamic(
  () => import('@/components/feedback/FeedbackChart').then(module => module.FeedbackChart),
  { ssr: false, loading: () => <div className="skeleton" aria-hidden="true" style={{ height: 320, borderRadius: 8 }} /> },
)
  ...
  return (
    <div className="page">
      ...
      <section>
        ...
        <FeedbackChart data={chartData} labels={{
          bug: cs ? 'Chyba' : 'Bug',
          idea: cs ? 'Nápad' : 'Idea',
          confusing: cs ? 'Nesrozumitelné' : 'Confusing',
        }} />
      </section>
