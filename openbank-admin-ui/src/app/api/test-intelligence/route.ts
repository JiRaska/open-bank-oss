...
function runtimeFreshnessState(state: EvidenceState, observedAt: string | null | undefined): EvidenceState {
...
function enforceRuntimeFreshness(report: TestIntelligenceReport): TestIntelligenceReport {
