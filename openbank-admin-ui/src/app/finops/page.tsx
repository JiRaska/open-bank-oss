                  ...
                  {lifecycle.versions.map(v => (
                    <tr key={v.version}
                      ...
                      <td style={{ padding: '10px 12px', fontFamily: 'monospace', fontWeight: v.isCurrent ? 800 : 500, color: v.isCurrent ? 'var(--accent-text)' : 'var(--text-primary)', whiteSpace: 'nowrap' }}>
                        {v.isCurrent && <span style={{ marginRight: '6px', fontSize: '10px', background: 'var(--accent-strong)', color: 'var(--on-accent-strong)', padding: '1px 5px', borderRadius: '4px', verticalAlign: 'middle' }}>CURRENT</span>}
                        {v.version}
                      </td>
