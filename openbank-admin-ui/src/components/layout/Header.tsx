...
export function Header({ mobileNavOpen, onMenuToggle }: { mobileNavOpen?: boolean; onMenuToggle?: () => void }) {
  ...
  const primaryRole = ['ROLE_ADMIN', 'ROLE_SUPERVISOR', 'ROLE_COMPLIANCE', 'ROLE_KYC_REVIEWER', 'ROLE_KYC_OPENER', 'ROLE_KYC', 'ROLE_PAYMENTS', 'ROLE_RISK', 'ROLE_FINANCE', 'ROLE_AUDITOR', 'ROLE_OPERATOR', 'ROLE_VIEWER']
