...
const STATUS_STYLE: Record<TierStatus, { fg: string; bg: string; border: string; dashed?: boolean }> = {
  live:      { fg: 'var(--success-text)', bg: 'rgba(5,150,105,0.10)',  border: 'rgba(5,150,105,0.35)' },
  planned:   { fg: 'var(--warning-text)', bg: 'rgba(217,119,6,0.10)',  border: 'rgba(217,119,6,0.40)', dashed: true },
  candidate: { fg: 'var(--text-secondary)', bg: 'rgba(107,114,128,0.10)', border: 'rgba(107,114,128,0.30)', dashed: true },
  always_on: { fg: 'var(--text-secondary)', bg: 'rgba(107,114,128,0.08)', border: 'rgba(107,114,128,0.25)' },
}
