...
const STATUS_STYLE: Record<TierStatus, { fg: string; bg: string; border: string; dashed?: boolean }> = {
  ...
  candidate: { fg: 'var(--text-secondary)', bg: 'var(--surface-3)', border: 'var(--border-strong)', dashed: true },
  always_on: { fg: 'var(--text-secondary)', bg: 'var(--surface-3)', border: 'var(--border-strong)' },
}
