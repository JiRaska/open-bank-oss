...
export function TestIntelligenceFlow({ report }: { report?: TestIntelligenceReport | null }) {
  ...
  const stages: Stage[] = useMemo(() => [
    {
      ...
      icon: GitPullRequest, tone: 'var(--ti-stage-change)',
    },
    {
      ...
      icon: FlaskConical, tone: 'var(--ti-stage-prove)',
    },
    {
      ...
      icon: Boxes, tone: 'var(--ti-stage-runtime)',
    },
    {
      ...
      icon: Gauge, tone: 'var(--ti-stage-challenge)',
    },
    {
      ...
      icon: Radar, tone: 'var(--ti-stage-observe)',
    },
    {
      ...
      icon: BrainCircuit, tone: 'var(--ti-stage-reason)',
    },
    {
      ...
      icon: Users, tone: 'var(--ti-stage-decide)',
    },
  ], [t])
  ...
  return <section className="ti-system" aria-labelledby="test-intelligence-flow-title">
    ...
    <style jsx>{`
      .ti-system{--ink:var(--ti-ink);position:relative;isolation:isolate;overflow:hidden;margin-bottom:24px;padding:24px;border:1px solid color-mix(in srgb,var(--accent) 34%,var(--border));border-radius:20px;background:linear-gradient(145deg,var(--ti-canvas-start) 0%,var(--ti-canvas-middle) 52%,var(--ti-canvas-end) 100%);box-shadow:0 24px 70px color-mix(in srgb,var(--ti-shadow) 32%,transparent);color:var(--ink)}
      .ti-system:before{content:"";position:absolute;inset:0;z-index:-1;opacity:.3;background-image:linear-gradient(color-mix(in srgb,var(--ti-grid) 8%,transparent) 1px,transparent 1px),linear-gradient(90deg,color-mix(in srgb,var(--ti-grid) 8%,transparent) 1px,transparent 1px);background-size:32px 32px;mask-image:linear-gradient(to bottom,var(--ti-mask),transparent 82%)}
      .ti-aurora{position:absolute;z-index:-1;width:520px;height:260px;left:35%;top:-180px;border-radius:50%;background:radial-gradient(circle,color-mix(in srgb,var(--ti-stage-change) 30%,transparent),color-mix(in srgb,var(--chart-series-4) 12%,transparent) 42%,transparent 70%);filter:blur(20px);animation:aurora 9s ease-in-out infinite alternate}
      .ti-hero{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:28px;align-items:start}.ti-kicker{display:inline-flex;align-items:center;gap:7px;font-size:10px;font-weight:800;letter-spacing:.18em;color:var(--ti-grid)}.ti-hero h2{max-width:820px;margin:8px 0 5px;font-size:clamp(20px,2.3vw,34px);line-height:1.08;letter-spacing:-.035em}.ti-hero p{max-width:760px;margin:0;color:var(--ti-copy);font-size:12px;line-height:1.55}
      .ti-health{display:grid;grid-template-columns:auto auto;column-gap:10px;align-items:center;min-width:155px;padding:11px 13px;border:1px solid color-mix(in srgb,var(--ti-stage-prove) 35%,transparent);border-radius:13px;background:color-mix(in srgb,var(--ti-stage-prove) 7%,transparent)}.ti-health i{grid-row:1/3;width:9px;height:9px;border-radius:50%;background:var(--ti-stage-prove);box-shadow:0 0 16px var(--ti-stage-prove);animation:breathe 1.7s ease-in-out infinite}.ti-health span{font-size:8px;font-weight:800;letter-spacing:.13em;color:var(--ti-success-copy)}.ti-health strong{font-size:22px;line-height:1}.ti-health small{grid-column:2;color:var(--ti-copy-muted);font-size:8px}.ti-health.attention{border-color:color-mix(in srgb,var(--ti-stage-challenge) 42%,transparent);background:color-mix(in srgb,var(--ti-stage-challenge) 8%,transparent)}.ti-health.attention i{background:var(--ti-stage-challenge);box-shadow:0 0 16px var(--ti-stage-challenge)}.ti-health.attention span{color:var(--ti-warning-copy)}
      .ti-rail{position:relative;display:grid;grid-template-columns:repeat(7,minmax(110px,1fr));gap:8px;margin:28px 0 14px}.ti-beam{position:absolute;left:5%;right:5%;top:27px;height:2px;overflow:hidden;background:linear-gradient(90deg,transparent,color-mix(in srgb,var(--ti-grid) 28%,transparent) 8%,color-mix(in srgb,var(--ti-stage-runtime) 38%,transparent) 50%,color-mix(in srgb,var(--ti-stage-reason) 30%,transparent) 80%,transparent)}.ti-beam i{position:absolute;width:15%;height:100%;background:linear-gradient(90deg,transparent,var(--ti-beam),transparent);filter:drop-shadow(0 0 7px var(--ti-stage-change));animation:travel 3.8s linear infinite}
      .ti-stage{--stage:var(--ti-stage-change);position:relative;display:flex;min-width:0;min-height:142px;flex-direction:column;align-items:flex-start;gap:10px;padding:13px 11px;text-align:left;border:1px solid color-mix(in srgb,var(--ti-state-unresolved) 16%,transparent);border-radius:14px;background:linear-gradient(180deg,color-mix(in srgb,var(--ti-stage-surface) 92%,transparent),color-mix(in srgb,var(--ti-stage-surface-deep) 90%,transparent));color:inherit;cursor:pointer;transition:transform .2s,border-color .2s,background .2s;animation:stage-in .45s both;animation-delay:var(--delay)}.ti-stage:hover,.ti-stage.active{transform:translateY(-4px);border-color:color-mix(in srgb,var(--stage) 70%,transparent);background:linear-gradient(180deg,color-mix(in srgb,var(--stage) 14%,var(--ti-stage-surface)),var(--ti-stage-surface-deep));box-shadow:0 12px 34px color-mix(in srgb,var(--stage) 12%,transparent)}.ti-stage:focus-visible{outline:2px solid var(--stage);outline-offset:2px}.ti-stage-icon{position:relative;z-index:1;display:grid;width:38px;height:38px;place-items:center;border:1px solid color-mix(in srgb,var(--stage) 48%,transparent);border-radius:12px;background:color-mix(in srgb,var(--stage) 12%,var(--ti-canvas-middle));color:var(--stage);box-shadow:0 0 20px color-mix(in srgb,var(--stage) 12%,transparent)}.ti-stage-copy{display:grid;gap:4px;min-width:0}.ti-stage-copy small{font-size:7px;font-weight:800;letter-spacing:.12em;color:var(--stage)}.ti-stage-copy strong{font-size:12px;line-height:1.2}.ti-stage-copy em{font-size:8px;line-height:1.35;color:var(--ti-copy-muted);font-style:normal}.ti-stage-index{position:absolute;right:8px;top:7px;font:700 9px/1 monospace;color:color-mix(in srgb,var(--ti-state-unresolved) 25%,transparent)}
      .ti-explain{display:grid;grid-template-columns:210px 1fr 1fr;gap:1px;overflow:hidden;border:1px solid color-mix(in srgb,var(--ti-state-unresolved) 16%,transparent);border-radius:14px;background:color-mix(in srgb,var(--ti-state-unresolved) 14%,transparent)}.ti-explain>div{min-height:84px;padding:15px;background:var(--ti-canvas-middle)}.ti-explain-title{--stage:var(--ti-stage-change);display:flex;align-items:center;gap:11px;color:var(--stage)}.ti-explain-title div{display:grid;gap:4px}.ti-explain-title small{font-size:7px;font-weight:800;letter-spacing:.13em}.ti-explain-title strong{font-size:15px;color:var(--ink)}.ti-proof,.ti-boundary{display:flex;gap:10px;color:var(--ti-stage-prove)}.ti-boundary{color:var(--ti-boundary)}.ti-proof div,.ti-boundary div{display:grid;align-content:center;gap:5px}.ti-proof b,.ti-boundary b{font-size:9px;letter-spacing:.08em}.ti-proof span,.ti-boundary span{font-size:10px;line-height:1.45;color:var(--ti-copy)}
      .ti-signals{display:grid;grid-template-columns:repeat(6,1fr);gap:8px;margin-top:10px}.ti-signals>div{display:grid;grid-template-columns:auto 1fr;gap:2px 7px;align-items:center;padding:9px 11px;border-radius:10px;background:color-mix(in srgb,var(--ti-state-unresolved) 7%,transparent);color:var(--ti-grid)}.ti-signals span{font-size:8px;text-transform:uppercase;letter-spacing:.08em;color:var(--ti-copy-muted)}.ti-signals strong{grid-column:2;font-size:12px;color:var(--ink)}.ti-signals .state-passed{color:var(--ti-state-passed)}.ti-signals .state-failed{color:var(--ti-state-failed)}.ti-signals .state-not-run,.ti-signals .state-unknown{color:var(--ti-state-unresolved)}
