...
export function TestIntelligenceFlow({ report }: { report?: TestIntelligenceReport | null }) {
  ...
  return <section className="ti-system" aria-labelledby="test-intelligence-flow-title">
    ...
    <style jsx>{`
      ...
      .ti-stage{--stage:#38bdf8;position:relative;display:flex;min-width:0;min-height:142px;flex-direction:column;align-items:flex-start;gap:10px;padding:13px 11px;text-align:left;border:1px solid rgba(148,163,184,.16);border-radius:14px;background:linear-gradient(180deg,rgba(15,29,47,.92),rgba(10,20,35,.9));color:inherit;cursor:pointer;transition:transform .2s,border-color .2s,background .2s;animation:stage-in .45s both;animation-delay:var(--delay)}.ti-stage:hover,.ti-stage.active{transform:translateY(-4px);border-color:color-mix(in srgb,var(--stage) 70%,transparent);background:linear-gradient(180deg,color-mix(in srgb,var(--stage) 14%,#0f1d2f),#0a1423);box-shadow:0 12px 34px color-mix(in srgb,var(--stage) 12%,transparent)}.ti-stage:focus-visible{outline:2px solid var(--stage);outline-offset:2px}.ti-stage-icon{position:relative;z-index:1;display:grid;width:38px;height:38px;place-items:center;border:1px solid color-mix(in srgb,var(--stage) 48%,transparent);border-radius:12px;background:color-mix(in srgb,var(--stage) 12%,#0b1626);color:var(--stage);box-shadow:0 0 20px color-mix(in srgb,var(--stage) 12%,transparent)}.ti-stage-copy{display:grid;gap:4px;min-width:0}.ti-stage-copy small{font-size:9px;font-weight:800;letter-spacing:.12em;color:var(--stage)}.ti-stage-copy strong{font-size:12px;line-height:1.2}.ti-stage-copy em{font-size:10px;line-height:1.35;color:var(--muted);font-style:normal}.ti-stage-index{position:absolute;right:8px;top:7px;font:700 10px/1 monospace;color:rgba(148,163,184,.25)}
      .ti-explain{display:grid;grid-template-columns:210px 1fr 1fr;gap:1px;overflow:hidden;border:1px solid rgba(148,163,184,.16);border-radius:14px;background:rgba(148,163,184,.14)}.ti-explain>div{min-height:84px;padding:15px;background:#0b1626}.ti-explain-title{--stage:#38bdf8;display:flex;align-items:center;gap:11px;color:var(--stage)}.ti-explain-title div{display:grid;gap:4px}.ti-explain-title small{font-size:9px;font-weight:800;letter-spacing:.13em}.ti-explain-title strong{font-size:15px;color:var(--ink)}.ti-proof,.ti-boundary{display:flex;gap:10px;color:#22c55e}.ti-boundary{color:#fbbf24}.ti-proof div,.ti-boundary div{display:grid;align-content:center;gap:5px}.ti-proof b,.ti-boundary b{font-size:10px;letter-spacing:.08em}.ti-proof span,.ti-boundary span{font-size:11px;line-height:1.45;color:var(--muted)}
      .ti-signals{display:grid;grid-template-columns:repeat(6,1fr);gap:8px;margin-top:10px}.ti-signals>div{display:grid;grid-template-columns:auto 1fr;gap:2px 7px;align-items:center;padding:9px 11px;border-radius:10px;background:rgba(148,163,184,.07);color:#7dd3fc}.ti-signals span{font-size:9px;text-transform:uppercase;letter-spacing:.08em;color:var(--muted)}.ti-signals strong{grid-column:2;font-size:12px;color:var(--ink)}.ti-signals .state-passed{color:#4ade80}.ti-signals .state-failed{color:#f87171}.ti-signals .state-not-run,.ti-signals .state-unknown{color:#94a3b8}
