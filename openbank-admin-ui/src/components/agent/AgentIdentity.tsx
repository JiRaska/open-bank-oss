...
const PERSONAS: Record<string, PersonaDefinition> = {
  'compliance-officer': {
    ...
    accent: 'var(--accent-text)', glow: 'var(--accent-border)', shell: 'var(--accent-bg)', variant: 'guard', icon: ShieldCheck,
  },
  'ledger-domain-engineer': {
    ...
    accent: 'var(--success-text)', glow: 'var(--success-border)', shell: 'var(--success-bg)', variant: 'runner', icon: Braces,
  },
  'ui-assistant': {
    ...
    accent: 'var(--info-text)', glow: 'var(--info-border)', shell: 'var(--info-bg)', variant: 'guide', icon: MessageCircleQuestion,
  },
  'rca-investigator': {
    ...
    accent: 'var(--map-external)', glow: 'var(--info-border)', shell: 'var(--info-bg)', variant: 'lens', icon: SearchCheck,
  },
  'customer-copilot': {
    ...
    accent: 'var(--info-text)', glow: 'var(--info-border)', shell: 'var(--info-bg)', variant: 'guide', icon: LifeBuoy,
  },
  'mcp-anonymous': {
    ...
    accent: 'var(--success-text)', glow: 'var(--success-border)', shell: 'var(--success-bg)', variant: 'guard', icon: Network,
  },
  'ap2-anonymous': {
    ...
    accent: 'var(--accent-text)', glow: 'var(--accent-border)', shell: 'var(--accent-bg)', variant: 'lens', icon: BadgeCheck,
  },
  'finops-agent': {
    ...
    accent: 'var(--warning-text)', glow: 'var(--warning-border)', shell: 'var(--warning-bg)', variant: 'guide', icon: ChartNoAxesCombined,
  },
  'devops-agent': {
    ...
    accent: 'var(--warning-text)', glow: 'var(--warning-border)', shell: 'var(--warning-bg)', variant: 'runner', icon: Activity,
  },
  'control-liveness-sentinel': {
    ...
    accent: 'var(--text-secondary)', glow: 'var(--border-strong)', shell: 'var(--surface-2)', variant: 'lens', icon: Radar,
  },
  'governance-auditor': {
    ...
    accent: 'var(--accent-text)', glow: 'var(--accent-border)', shell: 'var(--accent-bg)', variant: 'guard', icon: Scale,
  },
  'release-steward': {
    ...
    accent: 'var(--danger-text)', glow: 'var(--danger-border)', shell: 'var(--danger-bg)', variant: 'runner', icon: GitPullRequest,
  },
  'docs-truth-agent': {
    ...
    accent: 'var(--info-text)', glow: 'var(--info-border)', shell: 'var(--info-bg)', variant: 'guide', icon: BookOpenCheck,
  },
  'authz-policy-auditor': {
    ...
    accent: 'var(--accent-text)', glow: 'var(--accent-border)', shell: 'var(--accent-bg)', variant: 'guard', icon: KeyRound,
  },
  'flaky-test-hunter': {
    ...
    accent: 'var(--danger-text)', glow: 'var(--danger-border)', shell: 'var(--danger-bg)', variant: 'lens', icon: TestTubeDiagonal,
  },
  'card-scheme-bulletin-agent': {
    ...
    accent: 'var(--info-text)', glow: 'var(--info-border)', shell: 'var(--info-bg)', variant: 'guide', icon: CreditCard,
  },
  ...
  'card-dispute-evidence-agent': {
    ...
    accent: 'var(--success-text)', glow: 'var(--success-border)', shell: 'var(--success-bg)', variant: 'lens', icon: SearchCheck,
  },
  'case-coordinator': {
    ...
    accent: 'var(--success-text)', glow: 'var(--success-border)', shell: 'var(--success-bg)', variant: 'guide', icon: ClipboardCheck,
  },
  ...
  'business-copilot': {
    ...
    accent: 'var(--warning-text)', glow: 'var(--warning-border)', shell: 'var(--warning-bg)', variant: 'guide', icon: Scale,
  },
}
...
const FALLBACK: PersonaDefinition = {
  ...
  accent: 'var(--text-tertiary)', glow: 'var(--border-strong)', shell: 'var(--surface-2)', variant: 'guide', icon: Bot,
}
