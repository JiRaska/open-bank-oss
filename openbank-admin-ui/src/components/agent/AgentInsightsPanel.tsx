...
export function AgentInsightsPanel({
  ...
  return (
    <div style={{ background: 'var(--surface)', border: `1px solid color-mix(in srgb, ${accentColor} 25%, transparent)`,
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                    {f.proposalUrl && (
                      <a href={f.proposalUrl} target="_blank" rel="noopener noreferrer"
                        style={{ fontSize: '11px', fontWeight: 700, color: 'var(--link)', textDecoration: 'none' }}>
                        ...
                        {onApprove && (
                          <button
                            ...
                            style={{ fontSize: '11px', fontWeight: 700, padding: '4px 12px', borderRadius: '8px',
                              border: 'none', background: 'var(--success-strong)', color: 'var(--on-success)', marginLeft: f.detectedAt ? 0 : 'auto',
