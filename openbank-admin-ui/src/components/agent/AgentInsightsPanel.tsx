...
export function AgentInsightsPanel({
  ...
  return (
    <div data-testid="agent-insights-panel" style={{ background: 'var(--surface)', border: `1px solid color-mix(in srgb, ${accentColor} 25%, var(--border))`,
                      ...
                      <>
                        {onApprove && (
                          <button
                            ...
                            aria-busy={decidingId === f.id}
                            style={{ fontSize: '11px', fontWeight: 700, padding: '4px 12px', borderRadius: '8px',
                              border: 'none', background: 'var(--success-text)', color: 'var(--text-inverse)', marginLeft: f.detectedAt ? 0 : 'auto',
