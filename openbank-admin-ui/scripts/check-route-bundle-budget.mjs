...
// Measured from a clean production webpack build on 2026-09-13:
// 129 route-owned chunks, 3,177,233 bytes total, largest /system/tests at 92,303 bytes.
// These are deliberately shrink-only ceilings, not aspirational performance claims.
export const MAX_ROUTE_CHUNK_BYTES = 92_303
export const MAX_TOTAL_ROUTE_CHUNK_BYTES = 3_177_233
