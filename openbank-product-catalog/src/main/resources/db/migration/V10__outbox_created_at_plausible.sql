...
--   SELECT count(*) FROM catalog_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE catalog_outbox DROP CONSTRAINT IF EXISTS catalog_outbox_created_at_plausible;
ALTER TABLE catalog_outbox
    ADD CONSTRAINT catalog_outbox_created_at_plausible
