...
object ProductSeed {
    val products: List<Product> = listOf(
        ...
        Product(
            id = "prod-016",
            code = "TERM_DEPOSIT_3M_CZK",
            name = "CZK Term Deposit 3M",
            shortDescription = "Korunový termínovaný vklad 3 měsíce, 5,2 % p.a.",
            type = "TERM_DEPOSIT",
            currency = "CZK",
            status = ProductStatus.ACTIVE,
            isPublic = true,
            ...
            termsAndConditions = listOf(
                TermsAndConditions(
                    version = "1.0",
                    url = "https://openbank.example/tac/term-deposit-3m-czk/v1.0",
                    effectiveFrom = LocalDate.of(2024, 9, 1),
                    language = "cs",
                ),
            ),
            ...
            description = "CZK 3-month term deposit at 5.2% p.a.",
            createdAt = Instant.parse("2024-09-01T10:00:00Z"),
            updatedAt = Instant.parse("2024-09-01T10:00:00Z"),
        ),
        Product(
