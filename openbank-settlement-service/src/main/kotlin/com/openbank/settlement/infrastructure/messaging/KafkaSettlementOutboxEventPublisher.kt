...
package com.openbank.settlement.infrastructure.messaging
...
@ApplicationScoped
class KafkaSettlementOutboxEventPublisher(
    @Channel("settlement-events-out") private val emitter: MutinyEmitter<String>,
