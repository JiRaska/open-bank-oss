...
package com.openbank.delegation.infrastructure.outbox
...
/** Drains the delegation transactional outbox (ADR-0050 / ADR-0232 D3). */
@ApplicationScoped
class DelegationOutboxDispatcher(
    private val repo: DelegationOutboxRepository,
    ...
    @Scheduled(
        ...
        identity = "delegation-outbox-dispatcher",
    )
    @Bulkhead(1)
