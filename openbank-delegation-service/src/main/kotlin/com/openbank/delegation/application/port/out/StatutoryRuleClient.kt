...
sealed interface StatutoryRuleResolution {
    /** Party roster matches, but KYB attestation freshness still needs an independent check. */
...
/** Reads signed policy evidence and current same-case mandates; not an issuance authorization. */
