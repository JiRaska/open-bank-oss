...
--   SELECT count(*) FROM delegation_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE delegation_outbox DROP CONSTRAINT IF EXISTS delegation_outbox_created_at_plausible;
ALTER TABLE delegation_outbox
    ADD CONSTRAINT delegation_outbox_created_at_plausible
