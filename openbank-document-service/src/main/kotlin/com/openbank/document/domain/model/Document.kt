...
data class Document(
    ...
    // Digest of the stored bytes once the ceremony completed and the bank's PAdES seal was applied.
    ...
    /** Records the digest of the sealed bytes now held under [storageKey]. */
    fun sealed(sealedBytesSha256: String): Document = copy(sealedSha256 = sealedBytesSha256)
