...
/**
 * Publishes the document outbox **backlog** (PENDING + FAILED rows) as the
 * `openbank.outbox.backlog` gauge tagged `service="document"` (ADR-0077 / ADR-0079).
 */
@Startup
@ApplicationScoped
class DocumentOutboxBacklogGauge : AbstractOutboxBacklogGauge {
    private lateinit var outboxRepository: DocumentOutboxRepository

    @Inject
    constructor(outboxRepository: DocumentOutboxRepository, metrics: DomainMetrics) : super(metrics) {
    ...
    override val service: String = "document"
