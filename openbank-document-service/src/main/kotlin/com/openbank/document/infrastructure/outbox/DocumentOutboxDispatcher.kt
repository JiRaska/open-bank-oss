...
/**
 * Drains the document transactional outbox (ADR-0050 / ADR-0049 D3).
 *
 ...
 * for the whole rollout duration, and both dispatch on their own tick. `DocumentOutboxRepositoryImpl`
 ...
 */
@ApplicationScoped
class DocumentOutboxDispatcher(
    private val repo: DocumentOutboxRepository,
    ...
    @Scheduled(
        ...
        identity = "document-outbox-dispatcher",
    )
    @Bulkhead(1)
