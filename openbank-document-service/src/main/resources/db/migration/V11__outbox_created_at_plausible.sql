...
--   SELECT count(*) FROM document_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE document_outbox DROP CONSTRAINT IF EXISTS document_outbox_created_at_plausible;
ALTER TABLE document_outbox
    ADD CONSTRAINT document_outbox_created_at_plausible
