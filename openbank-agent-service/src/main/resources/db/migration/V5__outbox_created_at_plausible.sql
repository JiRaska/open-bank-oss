...
--   SELECT count(*) FROM agent_audit_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE agent_audit_outbox DROP CONSTRAINT IF EXISTS agent_audit_outbox_created_at_plausible;
ALTER TABLE agent_audit_outbox
    ADD CONSTRAINT agent_audit_outbox_created_at_plausible
