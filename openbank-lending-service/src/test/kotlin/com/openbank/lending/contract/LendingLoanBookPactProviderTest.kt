 ...
 *
 * State seeding is plain JDBC — the reactive repositories cannot be driven from a JUnit callback
 * without a Vert.x context (HR000068). The seeded loan is disbursed in 2020, the pact's as-of year,
 * so it is the whole book at that date regardless of what other tests in this JVM booked today.
 */
@QuarkusTest
...
class LendingLoanBookPactProviderTest {
    ...
    @State("the loan book holds one active FIXED CZK loan with two remaining installments")
    fun oneFixedLoan() {
    ...
    private companion object {
        const val APP = "0190a4c0-0000-7000-8000-0000000a0001"
        const val LOAN = "0190a4c0-0000-7000-8000-0000000b0001"
        const val PARTY = "0190a4c0-0000-7000-8000-0000000c0001"

        // Idempotent: a re-run against a warm container finds the rows and changes nothing.
        val SEED = listOf(
            "INSERT INTO loan_application (id, party_id, requested_amount, currency, nominal_annual_rate, " +
                "term_periods, first_due_date, proposed_by) VALUES ('$APP', '$PARTY', 3000.00, 'CZK', 0.060000, 3, " +
                "DATE '2020-06-15', 'pact-seed') ON CONFLICT (id) DO NOTHING",
            "INSERT INTO loan (id, application_id, party_id, principal, currency, nominal_annual_rate, term_periods, " +
                ...
                "0.060000, 3, 'ANNUITY', DATE '2020-06-15', TIMESTAMPTZ '2020-05-15 09:00:00+00') ON CONFLICT (id) DO NOTHING",
