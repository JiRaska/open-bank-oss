...
/**
 * Regression coverage for #1201: two dispatcher instances racing [LendingOutboxRepositoryImpl]'s
...
class LendingOutboxClaimIT {

    @Inject
    lateinit var repository: LendingOutboxRepositoryImpl
    ...
    private fun seedPending(count: Int): List<OutboxMessage> {
        ...
        messages.forEach { msg -> onEventLoop { repository.persistInTransaction(msg).awaitSuspending() } }
        return messages
    }
