...
/**
 * Drains the lending transactional outbox (ADR-0050 / ADR-0049 D3).
 *
 ...
 * the whole rollout duration, and both dispatch on their own tick. `LendingOutboxRepositoryImpl`
 ...
 */
@ApplicationScoped
class LendingOutboxDispatcher(
    private val repo: LendingOutboxRepositoryImpl,
    ...
    @Scheduled(
        ...
        identity = "lending-outbox-dispatcher",
    )
    @Bulkhead(1)
