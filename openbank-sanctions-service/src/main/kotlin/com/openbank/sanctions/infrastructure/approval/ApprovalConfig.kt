...
package com.openbank.sanctions.infrastructure.approval
 ...
 * `openbank-sepa-payment`'s/`openbank-billing-service`'s `ApprovalConfig` — see
 * [RedisApprovalStore]'s KDoc for why this is a per-service `@Produces` rather than a
 * libs-side bean.
 */
@ApplicationScoped
