...
--   SELECT count(*) FROM sanctions_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE sanctions_outbox DROP CONSTRAINT IF EXISTS sanctions_outbox_created_at_plausible;
ALTER TABLE sanctions_outbox
    ADD CONSTRAINT sanctions_outbox_created_at_plausible
