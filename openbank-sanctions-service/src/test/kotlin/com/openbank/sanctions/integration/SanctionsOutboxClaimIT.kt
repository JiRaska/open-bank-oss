...
import com.openbank.sanctions.infrastructure.persistence.repository.SanctionsOutboxRepositoryImpl
 ...
 * [SanctionsOutboxRepositoryImpl]'s `claimProcessable` at the same instant (an Argo Rollouts
...
class SanctionsOutboxClaimIT {

    @Inject
    lateinit var repository: SanctionsOutboxRepositoryImpl
