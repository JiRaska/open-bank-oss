...
--   SELECT count(*) FROM interest_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE interest_outbox DROP CONSTRAINT IF EXISTS interest_outbox_created_at_plausible;
ALTER TABLE interest_outbox
    ADD CONSTRAINT interest_outbox_created_at_plausible
