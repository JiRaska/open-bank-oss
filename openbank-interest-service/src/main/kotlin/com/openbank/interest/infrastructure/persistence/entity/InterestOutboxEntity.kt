...
/**
 * `claimed_at` is interest-only — added straight on this entity, not on the shared
 ...
 * `InterestOutboxRepositoryImpl.claimProcessable`'s atomic claim query when a row moves to
