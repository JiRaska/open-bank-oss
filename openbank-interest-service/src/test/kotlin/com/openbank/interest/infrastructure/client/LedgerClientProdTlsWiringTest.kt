...
/**
 * The ADR-0033 §D capitalization credit leg reaches ledger-service over its private-CA mTLS
 ...
 * listener refuses the handshake at the first real post and the capitalization journal never lands.
 * That is silent config drift, not a compile error, so it is asserted here rather than assumed.
 *
