...
import com.openbank.tpp.infrastructure.kafka.KafkaTppOutboxEventPublisher
...
/**
 * Drains the tpp-registry transactional outbox (ADR-0050 / ADR-0049 D3).
 *
 ...
 * the whole rollout duration, and both dispatch on their own tick. `TppOutboxRepositoryImpl`
 ...
 */
@ApplicationScoped
class TppOutboxDispatcher(
    private val repo: TppOutboxRepository,
    private val publisher: KafkaTppOutboxEventPublisher,
    ...
    @Scheduled(
        ...
        identity = "tpp-registry-outbox-dispatcher",
    )
    @Bulkhead(1)
