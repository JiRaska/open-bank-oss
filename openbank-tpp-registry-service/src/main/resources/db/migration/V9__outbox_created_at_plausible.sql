...
--   SELECT count(*) FROM tpp_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE tpp_outbox DROP CONSTRAINT IF EXISTS tpp_outbox_created_at_plausible;
ALTER TABLE tpp_outbox
    ADD CONSTRAINT tpp_outbox_created_at_plausible
