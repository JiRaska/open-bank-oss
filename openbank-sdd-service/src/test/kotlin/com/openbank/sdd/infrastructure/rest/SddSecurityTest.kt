...
/**
 * Regression guard (C7/ADR-0030): no SEPA Direct Debit endpoint must be opened without role-gating.
 * Pure reflection — no Quarkus boot needed.
 */
class SddSecurityTest {

    @Test
    fun `no SddResource endpoint is @PermitAll`() {
        val methods = SddResource::class.java.declaredMethods.filter { m ->
