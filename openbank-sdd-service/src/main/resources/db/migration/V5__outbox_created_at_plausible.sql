...
--   SELECT count(*) FROM sdd_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE sdd_outbox DROP CONSTRAINT IF EXISTS sdd_outbox_created_at_plausible;
ALTER TABLE sdd_outbox
    ADD CONSTRAINT sdd_outbox_created_at_plausible
