 ...
 * pending-approvals queue (issue #5679, ADR-0227 D2), mirroring `openbank-sanctions-service`'s,
...
class ApprovalResourceMappingTest {
    ...
    fun `toResponse maps every field including a decided approval`() {
        ...
        assertThat(response.action).isEqualTo("fx.convert")
        assertThat(response.resourceId).isEqualTo("conversion-1")
