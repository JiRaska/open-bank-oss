...
--   SELECT count(*) FROM fx_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE fx_outbox DROP CONSTRAINT IF EXISTS fx_outbox_created_at_plausible;
ALTER TABLE fx_outbox
    ADD CONSTRAINT fx_outbox_created_at_plausible
