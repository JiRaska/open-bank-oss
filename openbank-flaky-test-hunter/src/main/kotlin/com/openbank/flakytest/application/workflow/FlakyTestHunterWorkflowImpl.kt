...
class FlakyTestHunterWorkflowImpl : FlakyTestHunterWorkflow {
    ...
    private val collect = Workflow.newActivityStub(CollectTestScanActivity::class.java, collectOptions)
    ...
    override fun runCheck(trigger: RunTrigger): FlakyTestReport {
        ...
        return FlakyTestReport(
            ...
            testFilesScanned = snapshot.testFilesScanned,
