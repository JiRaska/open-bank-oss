...
configurations.all {
    resolutionStrategy {
        ...
        force("io.netty:netty-codec-haproxy:4.2.18.Final")
        ...
        force("io.netty:netty-resolver-dns:4.2.18.Final")
        force("io.netty:netty-transport-native-epoll:4.2.18.Final")
        force("io.netty:netty-transport-native-kqueue:4.2.18.Final")
    }
}
