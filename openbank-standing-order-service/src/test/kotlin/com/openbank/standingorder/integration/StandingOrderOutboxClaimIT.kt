 ...
 * [StandingOrderOutboxRepositoryImpl]'s `claimProcessable` at the same instant (an Argo Rollouts
...
class StandingOrderOutboxClaimIT {

    @Inject
    lateinit var repository: StandingOrderOutboxRepositoryImpl
