...
/**
 * Drains the standing-order transactional outbox (ADR-0050 / ADR-0049 D3).
 *
 ...
 * `StandingOrderOutboxRepositoryImpl` therefore implements [OutboxRepository.claimProcessable]
 ...
 */
@ApplicationScoped
class StandingOrderOutboxDispatcher(
    private val repo: StandingOrderOutboxRepository,
    ...
    @Scheduled(
        ...
        identity = "standing-order-outbox-dispatcher",
    )
    @Bulkhead(1)
