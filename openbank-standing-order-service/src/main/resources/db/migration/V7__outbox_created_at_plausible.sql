...
--   SELECT count(*) FROM standing_order_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE standing_order_outbox DROP CONSTRAINT IF EXISTS standing_order_outbox_created_at_plausible;
ALTER TABLE standing_order_outbox
    ADD CONSTRAINT standing_order_outbox_created_at_plausible
