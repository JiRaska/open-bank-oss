...
dependencies {
    ...
    // (PolicyDecisionPoint / OpaSidecarPolicyDecisionPoint) lives here. Mandate signature
    // verification reuses the JDK JCA (like openbank-sca-service) — no JOSE dependency.
