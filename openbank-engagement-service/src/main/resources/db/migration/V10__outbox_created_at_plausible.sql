...
--   SELECT count(*) FROM engagement_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE engagement_outbox DROP CONSTRAINT IF EXISTS engagement_outbox_created_at_plausible;
ALTER TABLE engagement_outbox
    ADD CONSTRAINT engagement_outbox_created_at_plausible
