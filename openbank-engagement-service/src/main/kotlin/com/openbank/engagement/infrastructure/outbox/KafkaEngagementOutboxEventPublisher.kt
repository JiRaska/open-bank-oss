...
/** Publishes to `engagement.events` (ADR-0220 D2). Same shape as `KafkaAccountOutboxEventPublisher`. */
@ApplicationScoped
class KafkaEngagementOutboxEventPublisher(
    @Channel("engagement-outbox-out") private val emitter: MutinyEmitter<String>,
