...
--   SELECT count(*) FROM notification_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE notification_outbox DROP CONSTRAINT IF EXISTS notification_outbox_created_at_plausible;
ALTER TABLE notification_outbox
    ADD CONSTRAINT notification_outbox_created_at_plausible
