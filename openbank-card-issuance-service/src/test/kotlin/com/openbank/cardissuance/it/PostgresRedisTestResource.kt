 ...
 *
 * Throws [TestAbortedException] when Docker is unavailable (Hetzner runners without
 * Docker daemon) so the test is skipped rather than failed.
 */
class PostgresRedisTestResource : QuarkusTestResourceLifecycleManager {
    ...
    override fun start(): Map<String, String> {
        ...
        return mapOf(
            "quarkus.datasource.reactive.url" to "vertx-reactive:postgresql://$pgHost:$pgPort/openbank_cards_it",
            "quarkus.datasource.jdbc.url" to "jdbc:postgresql://$pgHost:$pgPort/openbank_cards_it",
