...
/**
 * AC11 (issue #2990): card-issuance must never call delegation-service synchronously
 * on the request path — enforcement reads the local projection.
 */
class NoDelegationRestClientTest {

    @Test
    fun `no REST client in this service targets delegation-service`() {
        val clientDir = File("src/main/kotlin/com/openbank/cardissuance/infrastructure/client")
