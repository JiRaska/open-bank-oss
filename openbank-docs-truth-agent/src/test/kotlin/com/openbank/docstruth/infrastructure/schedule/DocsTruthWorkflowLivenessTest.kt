...
class DocsTruthWorkflowLivenessTest {
    ...
    fun `scheduler registers gauge at startup and records success after workflow dispatch`(): Unit = runBlocking {
        ...
        val runCheck = mockk<RunDocsTruthCheckUseCase>()
        ...
        val scheduler = DocsTruthCheckScheduler().apply {
    ...
    private companion object {
        const val WORKFLOW = "docs-truth-check"
