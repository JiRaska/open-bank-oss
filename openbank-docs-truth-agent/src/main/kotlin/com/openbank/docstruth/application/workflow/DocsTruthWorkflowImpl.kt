...
class DocsTruthWorkflowImpl : DocsTruthWorkflow {
    ...
    private val collect = Workflow.newActivityStub(CollectRepoScanActivity::class.java, collectOptions)
    ...
    override fun runCheck(trigger: RunTrigger): DocsTruthReport {
        ...
        return DocsTruthReport(
            runId = runId,
            startedAt = startedAt,
            completedAt = completedAt,
            adrsScanned = snapshot.adrRecords.size,
