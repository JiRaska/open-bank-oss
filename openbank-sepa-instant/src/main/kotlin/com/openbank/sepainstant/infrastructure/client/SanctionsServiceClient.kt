 ...
 * (`POST /api/v1/sanctions/screen`). Carries the service OIDC token via the reactive client filter,
...
/** Mirror of sanctions-service `ScreenEntityCommand` (only the fields a name screen needs). */
