...
package com.openbank.sepainstant.infrastructure.observability
 ...
 *
 * `com.openbank.sepainstant.infrastructure.client.FraudScoringAdapter` is deliberately fail-OPEN: when
 ...
 *
 * Two series, both tagged `service="sepa-instant"`, `rail="SCT_INST"`:
 *
...
class FraudScoringMetrics {
    ...
    companion object {
        ...
        const val SERVICE = "sepa-instant"
        const val RAIL = "SCT_INST"
