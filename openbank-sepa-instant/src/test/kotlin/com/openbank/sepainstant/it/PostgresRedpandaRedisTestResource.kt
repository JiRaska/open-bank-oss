...
class PostgresRedpandaRedisTestResource : QuarkusTestResourceLifecycleManager {
    ...
    override fun start(): Map<String, String> {
        val pg = PostgreSQLContainer(DockerImageName.parse("postgres:16.3-alpine"))
            ...
            .withDatabaseName("openbank_sepa_instant_it")
        pg.start()
        postgres = pg
        ...
        return mapOf(
            "quarkus.datasource.reactive.url" to "vertx-reactive:postgresql://$host:$port/openbank_sepa_instant_it",
            "quarkus.datasource.jdbc.url" to "jdbc:postgresql://$host:$port/openbank_sepa_instant_it",
