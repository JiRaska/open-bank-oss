...
--   SELECT count(*) FROM kyb_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE kyb_outbox DROP CONSTRAINT IF EXISTS kyb_outbox_created_at_plausible;
ALTER TABLE kyb_outbox
    ADD CONSTRAINT kyb_outbox_created_at_plausible
