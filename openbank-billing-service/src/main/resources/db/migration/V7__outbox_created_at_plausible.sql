...
--   SELECT count(*) FROM billing_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE billing_outbox DROP CONSTRAINT IF EXISTS billing_outbox_created_at_plausible;
ALTER TABLE billing_outbox
    ADD CONSTRAINT billing_outbox_created_at_plausible
