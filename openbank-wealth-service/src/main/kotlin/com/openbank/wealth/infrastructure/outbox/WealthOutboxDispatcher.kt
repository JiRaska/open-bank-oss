...
package com.openbank.wealth.infrastructure.outbox
...
/**
 * Relays `wealth_outbox` rows to Kafka.
 *
 ...
 */
@ApplicationScoped
class WealthOutboxDispatcher(
    private val repo: WealthOutboxRepository,
    ...
    @Scheduled(
        ...
        identity = "wealth-outbox-dispatcher",
    )
    @Bulkhead(1)
