...
--   SELECT count(*) FROM case_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE case_outbox DROP CONSTRAINT IF EXISTS case_outbox_created_at_plausible;
ALTER TABLE case_outbox
    ADD CONSTRAINT case_outbox_created_at_plausible
