...
--   SELECT count(*) FROM account_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE account_outbox DROP CONSTRAINT IF EXISTS account_outbox_created_at_plausible;
ALTER TABLE account_outbox
    ADD CONSTRAINT account_outbox_created_at_plausible
