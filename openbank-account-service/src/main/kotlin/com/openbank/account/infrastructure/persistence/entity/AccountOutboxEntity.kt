...
/**
 * `claimed_at` is account-only — added straight on this entity, not on the shared
 ...
 * `AccountOutboxRepositoryImpl.claimProcessable`'s atomic claim query when a row moves to
