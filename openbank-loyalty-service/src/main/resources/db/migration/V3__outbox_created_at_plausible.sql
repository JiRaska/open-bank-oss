...
--   SELECT count(*) FROM loyalty_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE loyalty_outbox DROP CONSTRAINT IF EXISTS loyalty_outbox_created_at_plausible;
ALTER TABLE loyalty_outbox
    ADD CONSTRAINT loyalty_outbox_created_at_plausible
