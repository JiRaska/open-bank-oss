...
/** Publishes to `openbank.loyalty.events`. Same shape as `KafkaEngagementOutboxEventPublisher`. */
@ApplicationScoped
class KafkaLoyaltyOutboxEventPublisher(@Channel("loyalty-outbox-out") private val emitter: MutinyEmitter<String>) :
