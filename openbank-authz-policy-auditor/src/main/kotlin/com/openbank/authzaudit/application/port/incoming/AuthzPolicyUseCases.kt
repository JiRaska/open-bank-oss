...
package com.openbank.authzaudit.application.port.incoming
...
interface GetFindingsUseCase {
    suspend fun getActive(): List<AuthzPolicyFinding>
    suspend fun getById(id: String): AuthzPolicyFinding?
}
