...
class AuthzPolicyAuditorWorkflowImpl : AuthzPolicyAuditorWorkflow {
    ...
    private val collect = Workflow.newActivityStub(CollectPolicyScanActivity::class.java, collectOptions)
    private val detect = Workflow.newActivityStub(DetectDriftActivity::class.java, collectOptions)
    private val diagnosePropose = Workflow.newActivityStub(DiagnoseAndProposeActivity::class.java, diagnoseOptions)

    override fun runCheck(trigger: RunTrigger): AuthzPolicyReport {
        ...
        return AuthzPolicyReport(
            runId = runId,
            startedAt = startedAt,
            completedAt = completedAt,
            regoFilesScanned = snapshot.regoFilesScanned,
