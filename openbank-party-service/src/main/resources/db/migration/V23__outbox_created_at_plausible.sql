...
--   SELECT count(*) FROM party_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE party_outbox DROP CONSTRAINT IF EXISTS party_outbox_created_at_plausible;
ALTER TABLE party_outbox
    ADD CONSTRAINT party_outbox_created_at_plausible
