...
/**
 * Regression coverage for #1201: two dispatcher instances racing [PartyOutboxRepositoryImpl]'s
...
class PartyOutboxClaimIT {
    ...
    // PartyOutboxRepositoryImpl.persistInTransaction is a plain (non-override) method returning
    // Uni<PartyOutboxEntity> -- not part of the PartyOutboxRepository port interface, unlike
    // every sibling service's Uni<Void> version. Still callable the same way here.
