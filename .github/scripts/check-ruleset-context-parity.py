...
def main() -> int:
    ...
    try:
        ...
        # A gate that cannot reach the API must not report a silent pass — a token missing
        # `administration: read`, or the API being unreachable, is a tool failure, not "no
        # violations found".
