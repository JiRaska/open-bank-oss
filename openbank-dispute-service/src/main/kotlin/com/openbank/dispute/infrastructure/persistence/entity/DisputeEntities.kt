...
class DisputeEntity : PanacheEntityBase() {
    ...
    var disputeType: DisputeType = DisputeType.OTHER
    ...
    var transactionDate: LocalDate = LocalDate.EPOCH
    ...
    @Column(name = "chargeback_amount", precision = 20, scale = 4)
    var chargebackAmount: BigDecimal? = null

    @Column(name = "remediation_outcome")
    @Enumerated(EnumType.STRING)
    var remediationOutcome: RemediationOutcome? = null

    @Column(name = "remediation_amount", precision = 20, scale = 4)
    var remediationAmount: BigDecimal? = null
...
class DisputeEvidenceEntity : PanacheEntityBase() {
    ...
    var submittedAt: OffsetDateTime = OffsetDateTime.MIN
