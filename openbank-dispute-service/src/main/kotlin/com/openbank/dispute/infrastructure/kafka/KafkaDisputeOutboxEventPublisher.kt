...
package com.openbank.dispute.infrastructure.kafka
...
@ApplicationScoped
class KafkaDisputeOutboxEventPublisher(@Channel("dispute-outbox-out") private val emitter: MutinyEmitter<String>) :
