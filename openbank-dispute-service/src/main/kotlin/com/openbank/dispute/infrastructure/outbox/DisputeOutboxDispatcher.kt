...
/**
 * Drains the dispute transactional outbox (ADR-0050 / ADR-0049 D3).
 *
 ...
 * for the whole rollout duration, and both dispatch on their own tick. `DisputeOutboxRepositoryImpl`
 ...
 */
@ApplicationScoped
class DisputeOutboxDispatcher(
    private val repo: DisputeOutboxRepository,
    ...
    @Scheduled(
        ...
        identity = "dispute-outbox-dispatcher",
    )
    @Bulkhead(1)
