...
/**
 * Regression coverage for #1201: two dispatcher instances racing [DisputeOutboxRepositoryImpl]'s
...
class DisputeOutboxClaimIT {

    @Inject
    lateinit var repository: DisputeOutboxRepositoryImpl
