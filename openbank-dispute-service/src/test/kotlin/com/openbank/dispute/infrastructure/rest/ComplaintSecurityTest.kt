...
/**
 * Regression guard (C7/ADR-0030): no dispute/complaints endpoint must be opened without role-gating.
 * Pure reflection — no Quarkus boot needed.
 */
class ComplaintSecurityTest {

    @Test
    fun `no ComplaintResource endpoint is @PermitAll`() {
        val methods = ComplaintResource::class.java.declaredMethods.filter { m ->
