...
/** Isolated PostgreSQL per test JVM via Testcontainers (#1201 — dispute-service had no IT infra yet). */
class PostgresTestResource : QuarkusTestResourceLifecycleManager {
    ...
    override fun start(): Map<String, String> {
        ...
        return mapOf(
            "quarkus.datasource.reactive.url" to "vertx-reactive:postgresql://$host:$port/openbank_dispute_it",
            "quarkus.datasource.jdbc.url" to "jdbc:postgresql://$host:$port/openbank_dispute_it",
