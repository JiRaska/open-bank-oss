...
class ReleaseStewardWorkflowLivenessTest {
    ...
    fun `scheduler registers gauge at startup and records success after workflow dispatch`(): Unit = runBlocking {
        ...
        val runCheck = mockk<RunReleaseStewardCheckUseCase>()
        ...
        val scheduler = ReleaseStewardCheckScheduler().apply {
    ...
    private companion object {
        const val WORKFLOW = "release-steward-check"
