...
class ScheduledWorkflowIdTest {
    ...
    private fun id(trigger: RunTrigger, iso: String) =
        ReleaseStewardService.scheduledWorkflowId(trigger, Instant.parse(iso))
    ...
    fun `the day boundary is UTC, not the JVM default zone`() {
        ...
        assertEquals(
            "release-steward-check-scheduled-2026-08-02",
            id(RunTrigger.SCHEDULED, "2026-08-02T23:59:59Z"),
        )
        assertEquals(
            "release-steward-check-scheduled-2026-08-03",
