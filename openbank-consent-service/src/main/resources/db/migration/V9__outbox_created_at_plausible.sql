...
--   SELECT count(*) FROM consent_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE consent_outbox DROP CONSTRAINT IF EXISTS consent_outbox_created_at_plausible;
ALTER TABLE consent_outbox
    ADD CONSTRAINT consent_outbox_created_at_plausible
