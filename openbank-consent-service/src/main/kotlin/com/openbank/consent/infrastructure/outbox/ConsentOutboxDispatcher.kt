 ...
 * for the whole rollout duration, and both dispatch on their own tick. `ConsentOutboxRepositoryImpl`
 ...
 */
@ApplicationScoped
class ConsentOutboxDispatcher(
    private val repo: ConsentOutboxRepository,
