...
/**
 * `claimed_at` is swift-only — added straight on this entity, not the shared
 ...
 * `SwiftOutboxRepositoryImpl.claimProcessable`'s atomic claim query on DISPATCHING; read back
