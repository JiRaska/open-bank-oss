...
--   SELECT count(*) FROM swift_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE swift_outbox DROP CONSTRAINT IF EXISTS swift_outbox_created_at_plausible;
ALTER TABLE swift_outbox
    ADD CONSTRAINT swift_outbox_created_at_plausible
