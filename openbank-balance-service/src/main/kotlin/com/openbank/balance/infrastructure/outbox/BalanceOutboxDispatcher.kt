...
/**
 * Drains the balance transactional outbox (ADR-0050 / ADR-0049 D3).
 *
 ...
 * for the whole rollout duration, and both dispatch on their own tick. `BalanceOutboxRepositoryImpl`
 ...
 */
@ApplicationScoped
class BalanceOutboxDispatcher(
    private val repo: BalanceOutboxRepository,
    ...
    @Scheduled(
        ...
        identity = "balance-outbox-dispatcher",
    )
    @Bulkhead(1)
