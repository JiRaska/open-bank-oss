...
import com.openbank.balance.infrastructure.persistence.repository.BalanceOutboxRepositoryImpl
...
/**
 * Regression coverage for #1201: two dispatcher instances racing [BalanceOutboxRepositoryImpl]'s
...
class BalanceOutboxClaimIT {

    @Inject
    lateinit var repository: BalanceOutboxRepositoryImpl
