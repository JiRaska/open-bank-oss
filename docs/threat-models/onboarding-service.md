...
| **R**epudiation | Operator denies viewing a flagged sanctions case | Read access is audited via `@Audited` on detail endpoint; `AuditEvent` includes `actorId`, `resourceId`, `traceId` |
