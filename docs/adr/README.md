...
| ADR | Title | Decision | Delivery | Repos |
|----:|-------|----------|----------|-------|
...
| [0054](0054-finops-managed-version-lifecycle-and-cost-audit.md) | FinOps guardrails: managed-service version lifecycle + periodic cost audit | Accepted | Shipped | — |
...
| [0102](0102-agentic-ai-differentiation.md) | Agentic AI differentiation — tool-use banking agent, ML fraud, and LLM-assisted KYC | Accepted | Planned | — |
...
| [0147](0147-cross-repo-governance-delivery-status-beyond-the-monorepo.md) | Cross-repo governance — delivery status beyond the monorepo | Accepted | Shipped | — |
...
**Numbering gaps:** 0015 0127 0128 0129 0130 0131 0157 0161 0162 0163 0164 0165 do not correspond to a file in this repo's history —
