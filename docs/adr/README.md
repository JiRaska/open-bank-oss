...
[0030](0030-supply-chain-security-and-ssdlc-hardening.md). New ADRs copy
[TEMPLATE.md](TEMPLATE.md) and use the two-axis **Decision-Status** / **Delivery-Status** front-matter.
...
| [0012](0012-mpl-license-and-dco.md) | MPL-2.0 licence + Developer Certificate of Origin | Superseded by [ADR-0123] | — |
...
| [0115](0115-deterministic-simulation-harness.md) | Deterministic simulation harness — seed-driven money-path invariant checker (ADR-0100 Layer 2/3) | Accepted | — |
...
| [0120](0120-migrate-transaction-payment-orchestration-to-temporal.md) | Migrate transaction-service payment orchestration to Temporal | Proposed | — |
| [0121](0121-service-self-reported-sbom-and-supply-chain-attestation.md) | Service self-reported SBOM and supply-chain attestation | Proposed | — |
| [0122](0122-split-openbank-libs-into-domain-and-runtime.md) | Split openbank-libs into domain and runtime modules | Proposed | — |
| [0123](0123-relicense-to-apache-2.0.md) | Relicense the platform from MPL-2.0 to Apache-2.0 | Accepted | — |
| [0124](0124-oss-readiness-and-public-launch-hardening.md) | OSS-readiness and public-launch hardening | Proposed | — |
