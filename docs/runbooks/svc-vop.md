...
- Readiness: `TCP :8149` · Liveness: `GET :8086/q/health/live`
...
- **Scale:** `kubectl scale rollout/vop-service -n payments --replicas=<n>` (or edit the GitOps manifest — GitOps is source of truth, a later ArgoCD sync reconciles manual changes).
