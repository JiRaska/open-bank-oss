...
- **Scale:** `kubectl scale deploy/psd2-service -n psd2 --replicas=<n>` (or edit the GitOps manifest — GitOps is source of truth; a later ArgoCD sync reconciles manual changes).
