...
- **Scale:** `kubectl scale deploy/delegation-service -n delegation --replicas=<n>` (or edit the GitOps manifest — GitOps is source of truth, a manual scale is reverted by ArgoCD).
