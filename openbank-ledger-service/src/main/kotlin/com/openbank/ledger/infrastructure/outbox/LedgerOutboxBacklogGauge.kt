...
/**
 * Publishes the ledger outbox **backlog** (PENDING + FAILED rows) as the `openbank.outbox.backlog`
 * gauge tagged `service="ledger"` (ADR-0077 / ADR-0079 / ADR-0049 D3).
 *
...
@Startup
@Singleton
class LedgerOutboxBacklogGauge(private val outboxRepository: LedgerOutboxRepositoryImpl, metrics: DomainMetrics) :
    AbstractOutboxBacklogGauge(metrics) {

    override val service: String = "ledger"
