...
--   SELECT count(*) FROM ledger_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE ledger_outbox DROP CONSTRAINT IF EXISTS ledger_outbox_created_at_plausible;
ALTER TABLE ledger_outbox
    ADD CONSTRAINT ledger_outbox_created_at_plausible
