...
--   SELECT count(*) FROM fraud_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE fraud_outbox DROP CONSTRAINT IF EXISTS fraud_outbox_created_at_plausible;
ALTER TABLE fraud_outbox
    ADD CONSTRAINT fraud_outbox_created_at_plausible
