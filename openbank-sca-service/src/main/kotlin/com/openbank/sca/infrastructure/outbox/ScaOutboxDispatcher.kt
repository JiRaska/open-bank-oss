...
/**
 * Drains the sca transactional outbox (ADR-0050 / ADR-0049 D3).
 *
 ...
 * for the whole rollout duration, and both dispatch on their own tick. `ScaOutboxRepositoryImpl`
 ...
 */
@ApplicationScoped
class ScaOutboxDispatcher(
    private val repo: ScaOutboxRepository,
    ...
    @Scheduled(
        ...
        identity = "sca-outbox-dispatcher",
    )
    @Bulkhead(1)
