...
--   SELECT count(*) FROM sca_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE sca_outbox DROP CONSTRAINT IF EXISTS sca_outbox_created_at_plausible;
ALTER TABLE sca_outbox
    ADD CONSTRAINT sca_outbox_created_at_plausible
