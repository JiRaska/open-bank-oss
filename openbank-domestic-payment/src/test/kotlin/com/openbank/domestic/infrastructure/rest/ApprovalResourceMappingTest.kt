 ...
 * `openbank-sanctions-service`'s and `openbank-ledger-service`'s `ApprovalResourceMappingTest`.
 */
class ApprovalResourceMappingTest {
    ...
    fun `toResponse maps every field including a decided approval`() {
        ...
        assertThat(response.action).isEqualTo("domestic-payment.transitionStatus")
