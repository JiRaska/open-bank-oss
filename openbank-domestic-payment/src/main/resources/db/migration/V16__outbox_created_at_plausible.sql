...
--   SELECT count(*) FROM domestic_payment_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE domestic_payment_outbox DROP CONSTRAINT IF EXISTS domestic_payment_outbox_created_at_plausible;
ALTER TABLE domestic_payment_outbox
    ADD CONSTRAINT domestic_payment_outbox_created_at_plausible
