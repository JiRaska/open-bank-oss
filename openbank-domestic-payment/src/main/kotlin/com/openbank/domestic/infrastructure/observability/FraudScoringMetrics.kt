 ...
 *
 * `com.openbank.domestic.infrastructure.client.FraudScoringAdapter` is deliberately fail-OPEN: when
 ...
 *
 * Two series, both tagged `service="domestic"`, `rail="DOMESTIC"`:
 *
...
class FraudScoringMetrics {
    ...
    companion object {
        ...
        const val SERVICE = "domestic"
        const val RAIL = "DOMESTIC"
