...
// Code review finding (sepa-payment pilot): decide()/markExecuted() reject re-deciding or
// re-consuming an approval that isn't in the expected status. Surfaced as a 409, matching
// the fleet convention for state-machine violations.
@Provider
