...
/**
 * Drains the clearing transactional outbox (ADR-0050 / ADR-0049 D3).
 *
 ...
 * for the whole rollout duration, and both dispatch on their own tick. `ClearingOutboxRepositoryImpl`
 ...
 */
@ApplicationScoped
class ClearingOutboxDispatcher(
    private val repo: ClearingOutboxRepository,
    ...
    @Scheduled(
        ...
        identity = "clearing-outbox-dispatcher",
    )
    @Bulkhead(1)
