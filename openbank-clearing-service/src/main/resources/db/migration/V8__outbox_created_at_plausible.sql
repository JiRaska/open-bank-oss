...
--   SELECT count(*) FROM clearing_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE clearing_outbox DROP CONSTRAINT IF EXISTS clearing_outbox_created_at_plausible;
ALTER TABLE clearing_outbox
    ADD CONSTRAINT clearing_outbox_created_at_plausible
