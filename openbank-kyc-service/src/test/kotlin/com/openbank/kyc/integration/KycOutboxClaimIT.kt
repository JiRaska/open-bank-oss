...
import com.openbank.kyc.infrastructure.persistence.repository.KycOutboxRepositoryImpl
...
/**
 * Regression coverage for #1201: two dispatcher instances racing [KycOutboxRepositoryImpl]'s
...
class KycOutboxClaimIT {

    @Inject
    lateinit var repository: KycOutboxRepositoryImpl
