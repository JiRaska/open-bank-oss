...
--   SELECT count(*) FROM kyc_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE kyc_outbox DROP CONSTRAINT IF EXISTS kyc_outbox_created_at_plausible;
ALTER TABLE kyc_outbox
    ADD CONSTRAINT kyc_outbox_created_at_plausible
