...
-- Rollback: DROP SEQUENCE kyc_cases_seq,kyc_outbox_seq;

CREATE SEQUENCE IF NOT EXISTS kyc_cases_seq INCREMENT BY 50;
CREATE SEQUENCE IF NOT EXISTS kyc_outbox_seq INCREMENT BY 50;
