...
--   SELECT count(*) FROM transaction_outbox WHERE created_at < TIMESTAMPTZ '2020-01-01';
--
-- Rollback: ALTER TABLE transaction_outbox DROP CONSTRAINT IF EXISTS transaction_outbox_created_at_plausible;
ALTER TABLE transaction_outbox
    ADD CONSTRAINT transaction_outbox_created_at_plausible
